//
//  FeelingPlanetViewController.swift
//

import UIKit

class FeelingPlanetViewController: ViewController {
    ...
    private let presenter = FeelingPlanetViewPresenter()
    override func viewDidLoad() {
        super.viewDidLoad()
        title = NSLocalizedString("FeelingPlanet", comment: "")
        setupView()
        setupPresenter()
    }
...
extension FeelingPlanetViewController: UITableViewDataSource, UITableViewDelegate {
...
extension FeelingPlanetViewController: FeelingPlanetViewPresenterDelegate {
...
extension FeelingPlanetViewController: UIGestureRecognizerDelegate {
